(function () {
  ...
  function buildPlaywrightJsTsTopics() {
    var items = [
      ...
      ['Hoisting', 'Level 1 - JavaScript Foundations', 'Scope', 'Hoisting explains why some declarations are available before the line where they appear. Function declarations are hoisted, while let and const remain unavailable before declaration.', 'For clean automation code, declare variables before using them and avoid relying on hoisting tricks.', [{ title: 'var hoisting and function hoisting', code: 'console.log(age); // undefined\nvar age = 5;\nconsole.log(age); // 5\n\nsayHello();\nfunction sayHello() {\n  console.log("Hello");\n}\n\n// console.log(userName); // error with let/const before declaration\nconst userName = "qa_user";' }]],
      ...
      ['Arrays', 'Level 2 - Working with Data', 'Loops and Data Types', 'Arrays store multiple values in one variable, such as users, roles, products, countries, or expected table rows. Access values by index and loop through them.', 'Arrays are the base for data-driven Playwright tests.', [{ title: 'Basic, mixed and nested arrays', code: 'let arr = ["java", "playwright", "git", "github"];\nconsole.log(arr);\nconsole.log(arr[2]); // git\nconsole.log(arr[5]); // undefined\n\nlet arr1 = ["Wasim", 32, true, null, "Noida"];\nconsole.log(arr1[2]);\nconsole.log(arr1[3]);\n\nlet subjects = [\n  ["Math", 65, true],\n  ["eng", 65, true]\n];\nconsole.log(subjects);' }]],
      ...
      ['Array Methods', 'Level 2 - Working with Data', 'Arrays and Functions', 'Array methods help transform and inspect test data. Learn push, pop, shift, unshift, map, filter, find, includes, some, every, and forEach.', 'Use these methods to prepare expected values, find records, and validate groups of results.', [{ title: 'Update, add, remove and loop arrays', code: 'let fruits = ["Mango", "Orrange", "Apple"];\nconsole.log(fruits);\nfruits[1] = "Banana";\nconsole.log(fruits);\n\nfruits.push("Guava"); // add at end\nfruits.unshift("Pineapple"); // add at beginning\nfruits.pop(); // remove last\nfruits.shift(); // remove first\nconsole.log(fruits.length);\n\nvar country = ["India", "UK", "USA", "Japan"];\nfor (let i = 0; i < country.length; i++) {\n  console.log(country[i]);\n}\n\nfor (let value of country) {\n  console.log(value);\n}\n\nvar players = ["Virat", "Rohit", "Sachin", "Kallis", "Babar", "MSD"];\nfor (let value of players) {\n  console.log(value);\n  if (value == "Babar") {\n    break;\n  }\n}' }]],
